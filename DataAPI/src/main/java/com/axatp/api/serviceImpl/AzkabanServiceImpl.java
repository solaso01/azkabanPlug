package com.axatp.api.serviceImpl;
...
public class AzkabanServiceImpl implements AzkabanService {
    ...
    private String uri;
    private String sessionId = "82247db0-706f-4ab9-aeab-c3d21b4ec2d9";
    ...
    public AzkabanServiceImpl(String uri, String username, String password) {
        this.uri = uri;
    ...
    public FetchExecJobLogs fetchExecJobLogs(String execId, String jobId, int offset, int length) {
        ...
        System.out.println(MessageFormat.format(FETCH_EXEC_JOB_LOGS, uri, sessionId, execId, jobId, String.valueOf(offset),
                String.valueOf(length)));
    ...
    public FetchScheduleResponse fetchSchedule(String projectId, String flowId) {
        ...
        System.err.println(MessageFormat.format(FETCH_SCHEDULE, uri, sessionId, projectId, flowId));
